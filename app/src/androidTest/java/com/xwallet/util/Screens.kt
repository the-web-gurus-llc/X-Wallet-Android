...
import com.xwallet.uiview.KeyboardView
...
object ShowPaperKeyScreen : UiScreen<ShowPaperKeyScreen>() {
    ...
    val next = UiButton {
        withId(packageName, "next_button")
    }

    val word = UiView {
        withId(packageName, "word_button")
    }
}
...
object ProvePaperKeyScreen : UiScreen<ProvePaperKeyScreen>() {
    ...
    val firstWordLabel = UiTextView {
        withId(packageName, "first_word_label")
    }

    val lastWordLabel = UiTextView {
        withId(packageName, "last_word_label")
    }

    val firstWord = UiEditText {
        withId(packageName, "first_word")
    }

    val secondWord = UiEditText {
        withId(packageName, "second_word")
    }
}
...
//    }
    ...
    val wallets = KRecyclerView({
        ...
        itemType(KHomeScreen::KWalletItem)
    })
...
object KSettingsScreen : KScreen<KSettingsScreen>() {
    ...
    val recycler = KRecyclerView({
        ...
        itemType(KSettingsScreen::KSettingsItem)
    })
...
class KWalletScreen : Screen<KWalletScreen>() {
    ...
    val transactions = KRecyclerView({
        ...
        itemType(KWalletScreen::KTransactionItem)
    })
